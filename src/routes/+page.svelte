		...
		<section class="relative py-14 md:py-20">
			<div class="mx-auto w-full max-w-5xl px-6">
				<div class="mx-auto max-w-4xl text-center">
					<h1
						class="text-4xl leading-[1.05] font-semibold tracking-tight text-balance text-[rgb(var(--text))] md:text-6xl"
					>
						{site.hero.headline}
					</h1>
						...
						>
							...
							<div class="mt-auto pt-8">
								<a
									...
									href={plan.cta.href}
									onclick={() => trackSignupStart(`home_pricing_${plan.name.toLowerCase()}`)}
								>
									{plan.cta.label}
								</a>
							</div>
				...
				{#if site.pricing.freeLink}
					<div class="mt-6 text-center">
						<a
							...
							onclick={() => trackSignupStart('home_pricing_free_link')}
						>
